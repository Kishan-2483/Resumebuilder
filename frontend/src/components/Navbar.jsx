...
const Navbar = ({ isAuthenticated, currentPage, setCurrentPage, currentUser, handleLogout }) => {
    ...
    return (
        <nav className="fixed w-full z-50 transition-all duration-300 bg-white/80 backdrop-blur-md border-b border-gray-100/50 shadow-sm">
                ...
                <div className="flex justify-between items-center h-20">
                    ...
                    >
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-[10px] text-gray-400 font-medium tracking-wide uppercase">Pro Edition</span>
                        </div>
                    </div>
